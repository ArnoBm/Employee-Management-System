...
namespace EMS
{
    public partial class Employees : Form
    {
        ...
        private void AddBtn_Click(object sender, EventArgs e)
        {
            try
            {
                if (EmpNameTb.Text == "" || GenCb.SelectedIndex == -1 || DeptCb.SelectedIndex == -1 || DailySalTb.Text == "")
                {
                ...
                else
                {
                    ...
                    string Query = "insert into EmployeeTbl (EmpName, EmpGen, EmpDept, EmpDOB, EmpJDate, EmpSal) values ('{0}', '{1}', {2}, '{3}', '{4}', {5})";
        ...
        private void UpdateBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "Update EmployeeTbl set EmpName = '{0}', EmpGen = '{1}', EmpDept = {2}, EmpDOB = '{3}', EmpJDate = '{4}', EmpSal = {5} where Empid = {6}";
        ...
        private void EmployeeList_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DeptCb.Text = EmployeeList.SelectedRows[0].Cells[3].Value.ToString();
